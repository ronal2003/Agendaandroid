...
public class ListaClienteAdapter extends RecyclerView.Adapter<ListaClienteAdapter.clienteViewHolder> {
    ...
    public void onBindViewHolder(@NonNull clienteViewHolder holder, int position) {
        ...
        holder.viewCorreo.setText(listaclientes.get(position).getCorreo_electornico() + " " + listaclientes.get(position).getFechaNacimiento());
    }
        ...
        public clienteViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("cli_id", listaclientes.get(getAdapterPosition()).getId());
